const i18n = {
  en: {
    ...
    'hero.badge': 'Open source · MIT License · NEXUS Ecosystem',
    ...
    'nav.watcher': 'Watcher',
    'eco.title': 'Part of the NEXUS Ecosystem',
    'eco.desc': 'NEXUS works great standalone. But when combined with NEXUS Watcher, NEXUS Notify and NEXUS OS, it becomes the central hub of a complete homelab management suite. <strong>Each tool works. Together, they think.</strong>',
    'eco.1': 'NEXUS OS — unified dashboard & SSO',
    'eco.2': 'NEXUS Watcher — digest-based update detection',
    'eco.3': 'NEXUS Notify — unified alert routing',
    'eco.4': 'One env var activates full integration',
  },
  es: {
    'nav.github': 'GitHub',
    'nav.dockerhub': 'Docker Hub',
    'nav.getstarted': 'Empezar',
    'hero.badge': 'Código abierto · Licencia MIT · Ecosistema NEXUS',
    ...
    'nav.watcher': 'Watcher',
    'eco.title': 'Parte del Ecosistema NEXUS',
    'eco.desc': 'NEXUS funciona genial solo. Pero combinado con NEXUS Watcher, NEXUS Notify y NEXUS OS, se convierte en el hub central de una suite completa de gestión de homelab. <strong>Cada herramienta funciona sola. Juntas, piensan.</strong>',
    'eco.1': 'NEXUS OS — dashboard unificado y SSO',
    'eco.2': 'NEXUS Watcher — detección de actualizaciones por digest',
    'eco.3': 'NEXUS Notify — enrutamiento unificado de alertas',
    'eco.4': 'Una variable de entorno activa la integración completa',
  }
};
